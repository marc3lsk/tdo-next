  ...
  <>
    ...
    <Article>
      <p>
        ...
        Orava, ktorej základným pilierom je jednota. Myšlienka Tour de Orava sa
        rýchlo rozšírila a dodnes sa pelotón TdO stihol zdvojnásobiť. Dnes je
        toto podujatie jednou z najdôležitejších športových udalostí roka.
      </p>
      <strong className="block mt-5">Tričká</strong>
      <p>
        Preteky sú spojené s niekoľkými súťažami, ku ktorým je obyčajne
        pridružené farebné tričko. Aktuálny držiteľ ocenenia je oprávnený nosiť
      ...
      <strong className="block mt-5">Bodovanie</strong>
      <p>
        Bodové ohodnotenie prémii závisí od počtu aktívnych pretekárov na danej
        prémii. Posledný na prémii je bez bodu a každý pred ním má o bod viac,
        pričom maximum možných získaných bodov je päť. Pri rovnosti bodov o
        víťazovi rozhodujú vyššie umiestnenia v danej kategórii. Každý jazdec
        môže získať len jeden dres. Ak by vyhral viac získava len ten cennejší a
        ostatné prechádzajú na ďalšieho jazdca v poradí. Po každej horskej
        prémii sa všetci jazdci čakajú, ako aj po každom zjazde. Každá etapa má
        maximálne dve prémie. Jednu horskú (spravidla vrch najvyššieho kopca) a
        jednu rýchlostnú (spravidla v domovskej dedine).
      </p>
      <strong className="block mt-5">Súťaž družstiev</strong>
      <p>
      ...
      <strong className="block mt-5">História</strong>
      <p>Najviac celkových víťazstiev – 2x Pavol L. (2013, 2014) </p>
      <p>Najviac získaných prémii – Michal S. (8)</p>
      <strong className="block mt-5">Škandály</strong>
      <p>
        Škandály na TdO Škandálov v ročníku 2013 bolo mnoho a boli výlučne v
        réžii Ľuboša B. ktorý často prehrával za záhadných okolností, keď sa mu
        zasekla kapsa do kolesa, padla mu retiazka, pošmykol sa mu pedál, neuhol
        sa mu strom, nedal mu prednosť kamión alebo pár metrov pred cieľom
        stretol strýka a musel zosadnúť.
      </p>
      <strong className="block mt-5">Technické poruchy</strong>
      <p>
        V ročníku 2013 sa pár kilometrov pred koncom aktuálne vedúcemu jazdcovi
        Pavlovi L. prihodil defekt. Ostatní členovia jeho tímu sa rozhodli
        pokračovať ďalej bez neho. Ostal s ním len Juraj B. za čo by si určite
        zaslúžil cenu fair play keby sa taká udeľuje. Ani toto mu však
        nezabránilo v celkovom víťazstve.
      </p>
      <img
        ...
        className="mt-3"
      />
      <strong className="block mt-5">Zranenia</strong>
      <p>
        V ročníku 2015 spadol Peter Č. potom, čo mu chcel Paľo L. zablahoželať k
        víťazstvu na horskej prémii. Peťo však zabudol, že má obuté tretry a
        blahoželanie neustál. Z pádu si našťastie odniesol len ponaučenie.
      </p>
      <strong className="block mt-5">Víťazi</strong>
      <strong className="block mt-5">2016</strong>
      <div className="flex mt-5 space-x-5">
        <img src="/dresy/zlty_small.jpg" alt="2016 Žltý dres Marcel B." />
        <p>Marcel B.</p>
      </div>
      <strong className="block mt-5">2015</strong>
      <div className="flex mt-5 space-x-5">
        <img src="/dresy/zlty_small.jpg" alt="2015 Žltý dres Peter Č." />
        <p>Peter Č.</p>
      </div>
      <strong className="block mt-5">2014</strong>
      <div className="flex mt-5 space-x-5">
      ...
      <strong className="block mt-5">2013</strong>
      <div className="flex mt-5 space-x-5">
      ...
      <strong className="block mt-5">2012</strong>
      <div className="flex mt-5 space-x-5">
